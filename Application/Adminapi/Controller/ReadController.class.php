...
class ReadController extends FController {
	...
	public function read_listAction(){
		...
		{
            //获取所有推荐的ID
            $top = $this->gettop(Status::CatTypeRead);
		...
		if($result['list'] != [])
		{
            ...
            //判断推荐
            $top  = $this->topInfo()->getRecord(['top_type'=>Status::CatTypeRead,'content_id'=>$tops]);
